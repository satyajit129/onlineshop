                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('name',$category->name) }}" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Name">
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ old('slug',$category->name) }}" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug" readonly>
                                </div>
                                @error('slug')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if ($category->image)
                                        <img src="{{ asset('storage/images/' . $category->image) }}" alt="Category Image" style="max-width: 30px;height: 30px;">
                                    @else
